...
export const POST_BLOG_REQUEST = "BLOG.POST_BLOG_REQUEST";
export const POST_BLOG_SUCCESS = "BLOG.POST_BLOG_SUCCESS";
export const POST_BLOG_FAILURE = "BLOG.POST_BLOG_FAILURE";
